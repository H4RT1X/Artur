...
<body>
    ...
    <section id="home" class="logo">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiBBbLWhm1T7lasQYs2MPvOobfRB8zrbAYVg&s" alt="лого">
    ...
    <section id="contact">
        ...
        <div class="contacts">
            <p>Email: <a href="mail.to:Hartonic@yandex.kz">Hartonic@yandex.kz</a></p>
